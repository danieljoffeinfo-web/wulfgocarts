 ...
 * Brand glyphs.
 *
 * Inline SVG rather than an icon package: two paths do not justify a
 * dependency, and inlining means they render with the first paint instead of
 * waiting on a chunk. `currentColor` lets each caller set the colour.
 */
