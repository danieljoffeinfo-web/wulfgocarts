          ...
          <Reveal>
            <div>
              ...
              <p className="mt-5 max-w-md text-base leading-relaxed text-white/60">
                Sit in one. Take it for a run. Our golf cart showroom on
                Montague Drive is a short drive from the Cape Town CBD,
                Century City, Milnerton and the northern suburbs — and there
                is no pressure to buy anything on the day.
              </p>
